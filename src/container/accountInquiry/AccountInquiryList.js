...
const AccountInquiryList = ({ marketerData, handleDelete, rowSelection, handleChange, isModalOpen, setIsModalOpen, onLockToggle, selectedRows, setSelectedRows,
  ...
  const handleRowDelete = (row) => {
    ...
    const datalist = [
        {
          announcement: "Columbia Pipeline will undergo scheduled mai...",
          portal: "Marketer",
          date: "11/11/2024",
          status: "READ",
           },
        ...
        renderRowActions: ({ row }) => {
            return (
                ...
                {isModalOpen && <ModalPopup
                    ...
                    message1="Are you sure you want to delete this AccountInquiry?"
