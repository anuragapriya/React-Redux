...
import { CustomTextFieldInput, AutocompleteInput, CustomFormControl } from '_components';
...
const UserFilter = ({ isOpen, onClose, onOpen, portalsList, handleFilterSubmit, handleportal, portalId, changePortalName }) => {
    ...
    const { register, handleSubmit, control, reset, formState: { errors, isValid }, trigger, setValue } = useForm({
