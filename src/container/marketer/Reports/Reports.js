...
const Reports = () => {
  ...
  const columns = [
    {
      accessorKey: "title1",
      header: "Title",
      muiTableHeadCellProps: { sx: { backgroundColor: "#e3f2fd", fontWeight: "bold" } },
    },
    {
      accessorKey: "title2",
      header: "Title",
    ...
    },
    {
      accessorKey: "title4",
      header: "Title",
      muiTableHeadCellProps: { sx: { backgroundColor: "#e3f2fd", fontWeight: "bold", position: "relative" } },
      Cell: ({ cell }) => (
  ...
  const datalist = [
    { title1: "Field #1", title2: "Field #2", title3: "Field #3", title4: "Field #4", title5: "Field #5", title6: "Field #6" },
    { title1: "Field #1", title2: "Field #2", title3: "Field #3", title4: "Field #4", title5: "Field #5", title6: "Field #6" },
  ];
  ...
  return (
    <>
          ...
          <Grid size={{ xs: 12, sm: 12, md: 12 }}>
            <Grid container>
              <Grid size={{ xs: 12, sm: 12, md: 4 }}>
                <Typography variant="h2" className='userprofilelistcontent'>Reports <span>5 Days Requirements Forecast</span> </Typography>
              </Grid>
      ...
      data={datalist}
      enableStickyHeader
      muiTableContainerProps={{ sx: { maxHeight: 400 } }} // Makes table scrollable
      rowSelection={rowSelection}
              selectedRows={selectedRows}
              setSelectedRows={setSelectedRows}
              setRowSelection={setRowSelection}
              handleRefresh={handleRefresh}
              handleToggleActiveStatus={handleToggleActiveStatus}
              enableColumnFilters={false}  // Hide the filter icon
              enableGlobalFilter={false}   // Hide the search icon
              enableDensityToggle={false}  // Hide the density toggle
              enableFullScreenToggle={false} // Hide the fullscreen icon
    />
